...
@main
struct DataPipelineAgentCLI: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "data-pipeline-agent",
        abstract: "Process data using tool-based pipeline operations: read, filter, aggregate, query, and report."
    )

    @Argument(help: "A natural-language data processing request.")
    var goal: String
    ...
    @Option(name: .long, help: "Optional path to a data file for processing.")
    var dataFile: String?
