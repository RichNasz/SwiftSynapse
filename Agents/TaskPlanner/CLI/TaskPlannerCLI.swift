...
@main
struct TaskPlannerCLI: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "task-planner",
        abstract: "Decompose a complex goal into phases, prioritize, and synthesize a unified plan."
    )

    @Argument(help: "A complex goal to decompose into a structured plan.")
    var goal: String
