...
Thank you for your interest in contributing to SwiftSynapse!
...
If you've found a bug or unexpected behavior, [open a bug report](https://github.com/RichNasz/SwiftSynapse/issues/new?template=bug-report.yml). A good bug report includes:
...
Have an idea for a new capability or improvement? [Open a feature request](https://github.com/RichNasz/SwiftSynapse/issues/new?template=feature-request.yml). Focus on the **use case** — describe the problem you're trying to solve, not just the solution you have in mind.
